...
public class BundledProductPromotion implements Promotion {
    ...
    public BundledProductPromotion(List<String> items, Double promotedPrice) {
        this.appliedItems.addAll(items);
        this.promotedPrice = promotedPrice;
    }

    /**
     * Applies the bundle promotion to the cart provided and also makes adjustments for the cart contents once
    ...
    /**
     * Returns true if the cart meets the critera of the bundle promotion
     * @param cart
     * @return
     */
    @Override
